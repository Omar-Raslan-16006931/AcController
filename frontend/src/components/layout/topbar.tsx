  ...
  return (
    <header className="bg-background/80 sticky top-0 z-30 flex h-16 shrink-0 items-center gap-3 border-b px-4 backdrop-blur-md sm:px-6">
      ...
      <button
        ...
        className="text-muted-foreground hover:bg-accent/60 ml-2 hidden max-w-xs flex-1 items-center gap-2 rounded-xl border px-3 py-1.5 text-sm transition-colors sm:flex"
      >
